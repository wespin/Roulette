...
namespace Roulette.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IIRoulettesRepository, MongoDbRolulettesRepository>();
            services.AddControllers(p=> p.SuppressAsyncSuffixInActionNames=false);
